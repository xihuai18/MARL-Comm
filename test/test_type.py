...
def get_extend_replaybuffer(name: str, replaybuffer_cls: Type[ReplayBuffer], extend_keys: Tuple[str]) -> Type[ReplayBuffer]:
    return type(name, (replaybuffer_cls,), {"_reserved_keys": replaybuffer_cls._reserved_keys + extend_keys})
